>**Note**: Please **fork** the current Udacity repository so that you will have a **main** repository in **ducvinh2911** Github account. Clone the remote repository to your local machine. Later, as a part of the project "Post your Work on Github", you will push your proposed changes to the remote repository in your Github account.
